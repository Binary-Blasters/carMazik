...
const Navbar = () => {
  ...
  // refs for each button to compute position
  const newRef = useRef(null);
  const usedRef = useRef(null);
  const newsRef = useRef(null);
  const categoriesRef = useRef(null);

  // for delayed close to avoid flicker when moving between button & menu
          ...
          <div className="flex items-center gap-6 h-12">
            <nav className="flex items-center gap-6">
              ...
              >
                ...
                {openDropdown === "new" && (
                  <div
                    style={{ left: dropdownPos.left, top: dropdownPos.top, maxWidth: 150 }}
